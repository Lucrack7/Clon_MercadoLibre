...
const productos = [
    ...
    },
    {
        id: "notebook-01",
        titulo:
            "Samsung Galaxy Book3 15.6 Intel Core I3 6 Núcleos 8gb 256gb Color Silver",
        imagen: [
    ...
    },
    {
        id: "notebook-02",
        titulo:
            "Notebook Noblex N14x1000 14.1 Hd Intel Celeron 4gb/128gb Color Gris",
        imagen: [
    ...
    },
    {
        id: "notebook-03",
        titulo:
            "Notebook Hp 15-dy2061la Intel Core I3 1125g4 8gb 256gb Win10 Color Plateado",
        imagen: [
    ...
    },
    {
        id: "notebook-04",
        titulo:
            "Notebook Gamer Rog Strix G15 G513rm-hq084w 15.6 R7 512gb Color Eclipse gray",
        imagen: [
    ...
    productos.forEach((producto) => {
        ...
        div.innerHTML = `
            ...
            <div class="producto-detalles">
                ...
                <p class="producto-precio">$ ${producto.precio.toLocaleString()}<span class="descuento"> ${producto.descuento
            }% OFF</span></p>
    ...
    botonesCategorias.forEach((boton) => {
        boton.addEventListener("click", (e) => {
            if (e.currentTarget.id != "todos") {
                ...
                const productoCagegoria = productos.find(
                    (producto) => producto.categoria.id === e.currentTarget.id
                );
...
const contenedorProductoVisitado = document.querySelector(
...
function asignarEventListenerProductos() {
    ...
    divsProductos.forEach((producto) => {
        ...
        <div class="info-producto">
            ...
            <p class="precio-producto">$ ${prod.precio.toLocaleString()} <span class="descuento">${prod.descuento
                }% OFF</span></p>
        ...
        <div class="info-compra">
            ...
            <span class="cantidad">Cantidad: 1 unidad <span class="stock">(${prod.stock
                } disponibles)</span> </span>
    
            <button class="btn-agregar-al-carrito" id="${prod.id
                }">Agregar al Carrito</button>
    
            <span class="vendedor">Vendido por <a href="#">${prod.proveedor
                }</a></span>
...
function actualizarNumEnCarrito() {
    let nuevaCantEnCarrito = productosEnCarrito.reduce(
